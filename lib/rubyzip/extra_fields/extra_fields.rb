...
module Rubyzip
  module ExtraFields # :nodoc:
    ...
    #
    # For example, below, UniversalTime is preferred over NTFS and Unix1, and
    # Unix3 is preferred over Unix2 and Unix1. This is correct as UniversalTime
    # and Unix3 are the more modern fields.
    register_extra_field_type(NTFS, :atime, :ctime, :mtime)
    register_extra_field_type(Unix1, :atime, :mtime, :uid, :gid)
