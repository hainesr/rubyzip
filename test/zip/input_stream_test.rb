...
class ZipInputStreamTest < Minitest::Test
  ...
  def test_open_file_with_gp3bit_set
    ::Zip::InputStream.open('test/zip/data/gpbit3stored.zip') do |zis|
  ...
  def test_open_file_with_gp3bit_set_created_by_osx_archive
    ::Zip::InputStream.open('test/zip/data/osx-archive.zip') do |zis|
      error = assert_raises(::Zip::StreamingError) do
        zis.get_next_entry
      end
  ...
  def test_open_split_archive_raises_error
    ::Zip::InputStream.open('test/zip/data/invalid-split.zip') do |zis|
  ...
  def test_open_encrypted_archive_raises_error
    ::Zip::InputStream.open('test/zip/data/zipWithEncryption.zip') do |zis|
  ...
  def test_sysread_text_stored
    Zip::InputStream.open('test/zip/data/zipWithStoredCompression.zip') do |zis|
      zis.get_next_entry
  ...
  def test_sysread_text_stored_encrypted
    Zip::InputStream.open(
      'test/zip/data/zipWithStoredCompressionAndEncryption.zip',
  ...
  def test_sysread_binary_stored
    Zip::InputStream.open('test/zip/data/bin_stored.zip') do |zis|
      zis.get_next_entry
