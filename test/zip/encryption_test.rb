...
class EncryptionTest < Minitest::Test
  ENCRYPT_ZIP_TEST_FILE = 'test/zip/data/zipWithEncryption.zip'
  AES_128_ZIP_TEST_FILE = 'test/zip/data/zip-aes-128.zip'
  AES_256_ZIP_TEST_FILE = 'test/zip/data/zip-aes-256.zip'
  AES_KEKA_ZIP_TEST_FILE = 'test/zip/data/aes-keka.zip'
  INPUT_FILE1 = 'test/zip/data/file1.txt'
  INPUT_FILE2 = 'test/zip/data/file2.txt'
  INPUT_FILE3 = 'test/zip/data/zip-aes-128.txt'
  INPUT_FILE4 = 'test/zip/data/zip-aes-256.txt'
  INPUT_FILE5 = 'test/zip/data/mimetype'
