...
require_relative '../../../samples/zip/example_recursive'

require 'fileutils'

class ExampleRecursiveTest < Minitest::Test
  DIRECTORY_TO_ZIP  = 'test/zip/data/globTest'
  OUTPUT_DIRECTORY  = 'test/zip/data/example_recursive.zip'
  TEMP_DIRECTORY    = 'test/zip/data/tmp'
