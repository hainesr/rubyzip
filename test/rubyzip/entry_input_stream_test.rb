...
class EntryInputStreamTest < Minitest::Test
  ...
  def test_too_long_input_raises_error_by_default # rubocop:disable Metrics/AbcSize
    fake_size = 100
    entry = Minitest::Mock.new
    entry.expect(:compressed_size, ::File.size(BIN_LOREM_IPSUM_DEFLATED))
    entry.expect(:compression_method, Rubyzip::COMPRESSION_METHOD_DEFLATE)
  ...
  def test_invalid_crc32_raises_error_by_default # rubocop:disable Metrics/AbcSize
  ...
  def test_invalid_crc32_prints_warning # rubocop:disable Metrics/AbcSize
    text = StringIO.new('Test text of 29 characters...')
